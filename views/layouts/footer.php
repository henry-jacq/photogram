<div class="container px-md-5">
    <footer class="px-3">
        <div class="row">
            <div class="col-6 col-md-3 mb-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2"><a href="/discover" class="nav-link p-0 text-body-secondary">Discover</a></li>
                    <li class="nav-item mb-2"><a href="/pro/plans" class="nav-link p-0 text-body-secondary">Pricing</a></li>
            ...
            <div class="col-6 col-md-3 mb-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2"><a href="/terms-and-conditions" class="nav-link p-0 text-body-secondary">Terms and Conditions</a></li>
                </ul>
            </div>
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
            <p>© 2024 Photogram, Inc. All rights reserved.</p>
