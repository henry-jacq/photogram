...
let comment_clone = `<li id="comment" class="list-group-item border-0"><div class="d-flex"><div class="mt-1 me-1"><div class="me-2"><img id="commenter-avatar" class="border rounded-circle" src="" width="46" height="46" loading="lazy"/></div></div><div class="bg-body-tertiary border px-3 py-2 rounded w-100"><div class="d-flex justify-content-between mb-1"><h6 class="fw-semibold mb-0"><a id="commenter-name" class="link-body-emphasis" href=""></a></h6><small id="commented-time" class="ms-2">Now</small></div><p id="commenter-text" class="mb-2"></p></div></div></li>`;
